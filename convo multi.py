...
╔═══════════════════════════════════════════════════════════════════════════╗
║  {0}WNER      : KICK                                           ║
║  {1}RULL3X     : FUDIW MARRULEX                                          ║
║  {1}FACEBOK    : ❮❮  KICK ❯❯                                            ║
║  {2}RULS       : MULTI TOKEN CONVO                                           ║
║  {3}GITHUB     : KICKWINNERZ                                                   ║ 
║  {1}WH9TS9P    : +9230627292911                                             ║
╚═══════════════════════════════════════════════════════════════════════════╝
    ...
    while True:
        for message_index, message in enumerate(messages):
            ...
            try:
                ...
                print(Fore.GREEN + f"└────────────────────────────────────────────────────────────────────┘\n")
                print(Fore.YELLOW + "\033[1;37m<<======== MADE BY KICK ❤️‍🩹🙂======>>")
                print("\n" + ("─" * 80) + "\n")
            except requests.exceptions.RequestException:
...
def main():
    ...
    pastebin_url = "https://pastebin.com/EULqnuBd"  # URL of the pastebin containing the password
